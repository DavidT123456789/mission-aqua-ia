  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="mt-8 flex items-center justify-center gap-2 mx-auto bg-red-600 hover:bg-red-500 text-white px-8 py-4 rounded-lg font-bold text-xl transition-colors shadow-[0_0_20px_rgba(239,68,68,0.4)]"
      >
